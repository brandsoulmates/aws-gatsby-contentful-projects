...
const createCloudFrontDistribution = async (id) => {
  let s3OriginAccessIdentity = `origin-access-identity/cloudfront/${id}`;
  console.log('s3OriginAccessIdentity', s3OriginAccessIdentity)
...
//        */
//       CloudFrontDefaultCertificate: false, // true if using cloudfront domain
